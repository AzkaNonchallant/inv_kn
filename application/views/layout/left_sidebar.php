            ...
            <ul class="nav pcoded-inner-navbar" style="list-style: none;">
                ...
                <?php if ($level === "admin" || $level === "accounting") { ?>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class="nav-item <?= $uri == 'PPB' ? 'active' : '' ?>"><a href="<?= base_url('accounting/accounting_ppb') ?>" class="">PPB</a></li>
                        </ul>
                    </li>
                <?php } ?>
                ...
                <?php if ($level === "admin" || $level === "purchasing") { ?>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                <a href="javascript:" class="nav-link "><span class="pcoded-mitext">PPB Master Barang</span></a>
                                <ul class="pcoded-submenu">
                                    <li class="nav-item <?= $uri == 'prc_ppb_masterbarang' ? 'active' : '' ?>"><a href="<?= base_url('Purchasing/prc_ppb/Prc_ppb_masterbarang') ?>" class="">Master Barang</a></li>
                                    <li class="nav-item <?= $uri == 'Supplier' ? 'active' : '' ?>"><a href="<?= base_url('Purchasing/prc_ppb/Po_supplier/Prc_po_supplier') ?>" class="">Supplier</a></li>
                            ...
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="nav-item <?= $uri == 'PO Import' ? 'active' : '' ?>"><a href="<?= base_url('Purchasing/Po_import/Prc_po_import') ?>" class="">PO Import</a></li>
                                    <li class="nav-item <?= $uri == 'Supplier' ? 'active' : '' ?>"><a href="<?= base_url('Purchasing/Po_rekap/Prc_po_rekap') ?>" class="">Rekap Import</a></li>
                                   
                                </ul>
                            </li>

                            <li class="nav-item <?= $uri == 'PO Reg' ? 'active' : '' ?>"><a href="<?= base_url('Purchasing/PO_reg/Prc_po_reg') ?>" class="">PO Reg</a></li>
                            ...
                            <li class="nav-item <?= $uri == 'PO Reg' ? 'active' : '' ?>"><a href="<?= base_url('Purchasing/Prc_dpb/Prc_dpb') ?>" class="">DPB</a></li>
                ...
                <?php if ($level === "admin" || $level === "forming") { ?>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                <a href="javascript:" class="nav-link "></span><span class="pcoded-mtext">Master Melting</span></a>
                                <ul class="pcoded-submenu">
                ...
                <?php if ($level === "admin" || $level === "stockkeeper") { ?>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progres Tooltip popovers Carousel Cards Collapse tabs pills Modal Grid System Typoghrapy Extra Shdaows Embeds" class="nav-item pcoded-hasmenu">
                        <a href="javascript:" class="nav-link"><span class="pcoded-micon"><i class="feather icon-package"></i></span><span class="pcoded-mnext">Stock Keeper</span></a>
                        <ul class="pcoded-submenu">
                        <li class="nav-item <?= $uri == 'forming' ? 'active' : '' ?>"><a href="<?= base_url('Stock_keeper/Sk_dpb') ?>" class="nav-link">DPB</a></li>
                        <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                <a href="javascript:" class="nav-link "><span class="pcoded-mtext">Kelola Barang</span></a>
                                <ul class="pcoded-submenu">
    ...
    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
        ...
        <ul class="pcoded-submenu">
            <li class="nav-item <?= $uri == 'Laporan_barang_masuk' ? 'active' : '' ?>">
                <a href="<?= base_url('Stock_keeper/Sk_laporan_barang_masuk') ?>" class="nav-link">Laporan Barang Masuk</a>
            </li>
            <li class="nav-item <?= $uri == 'Laporan_barang_keluar' ? 'active' : '' ?>">
                <a href="<?= base_url('Stock_keeper/Laporan_barang_keluar') ?>" class="nav-link">Laporan Barang Keluar</a>
            </li>
        </ul>
    </li>
</ul>
