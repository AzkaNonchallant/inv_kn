<!-- Modal Uji Pewarna -->
<div class="modal fade" id="edit_ujimp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp/update">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="e_jarak_lebur" name="jarak_lebur" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="e_keasaman" name="keasaman" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
...
<!-- <script type="text/javascript">
    $(document).ready(function() {
        $('#edit_ujimp').on('show.bs.modal', function(event) {
            ...
            $(this).find('#e_jarak_lebur').val(jarak_lebur)
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#edit_ujimp').on('show.bs.modal', function(event) {
            ...
            $(this).find('#e_jarak_lebur').val(jarak_lebur)
            $(this).find('#e_jarak_lebur').trigger("chosen:updated")
            $(this).find('#e_keasaman').val(keasaman)
            $(this).find('#e_keasaman').trigger("chosen:updated")
            $(this).find('#e_s_pengeringan').val(s_pengeringan)
            $(this).find('#e_s_pemijaran').val(s_pemijaran)
            $(this).find('#e_p_kadar').val(p_kadar)
            $(this).find('#e_kondisi_py').val(kondisi_py)
