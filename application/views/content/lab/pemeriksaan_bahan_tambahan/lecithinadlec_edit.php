<!-- Modal Uji Pewarna -->
<div class="modal fade" id="edit_ujila" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la/update">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="e_viscosity" name="viscosity" autocomplete="off" placeholder="Viscosity" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="e_ang_lempeng_tot" name="ang_lempeng_tot" autocomplete="off" placeholder="Angka Lempeng Total" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
...
<!-- <script type="text/javascript">
    $(document).ready(function() {
        $('#edit_ujila').on('show.bs.modal', function(event) {
            ...
            $(this).find('#e_viscosity').val(viscosity)
            $(this).find('#e_identifikasi').val(identifikasi)
            $(this).find('#e_ang_lempeng_tot').val(ang_lempeng_tot)
