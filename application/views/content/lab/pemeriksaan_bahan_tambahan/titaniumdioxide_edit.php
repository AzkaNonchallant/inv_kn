<!-- Modal Uji Pewarna -->
<div class="modal fade" id="edit_ujitd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td/update">
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control chosen-select" id="e_kel_h2so4p" name="kel_h2so4p" required>
                                                <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                                <option value="Sesuai">Sesuai</option>
                                                <option value="Tidak Sesuai">Tidak Sesuai</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control chosen-select" id="e_kel_hcip" name="kel_hcip" required>
                                                <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                                <option value="Sesuai">Sesuai</option>
                                                <option value="Tidak Sesuai">Tidak Sesuai</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control chosen-select" id="e_kel_air" name="kel_air" required>
                                                <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                                <option value="Sesuai">Sesuai</option>
                                                <option value="Tidak Sesuai">Tidak Sesuai</option>
                                            </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="e_identifikasi" name="identifikasi" autocomplete="off" placeholder="Identifikasi" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="tio2_h2so4" class="mt-2">0,5 gr TiO2 + H2SO4</label>
                                <select class="form-control chosen-select" id="e_tio2_h2so4" name="tio2_h2so4" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="e_s_pemijaran" name="s_pemijaran" autocomplete="off" placeholder="Sisa Pemijaran" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="kes_pewarna" class="mt-2">Kesamaan terhadap pewarna</label>
                                <select class="form-control chosen-select" id="e_kes_pewarna" name="kes_pewarna" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
...
<!-- <script type="text/javascript">
    $(document).ready(function() {
        $('#edit_ujitd').on('show.bs.modal', function(event) {
            ...
            $(this).find('#e_kel_h2so4p').val(kel_h2so4p)
            $(this).find('#e_kel_hcip').val(kel_hcip)
            $(this).find('#e_kel_air').val(kel_air)
            $(this).find('#e_identifikasi').val(identifikasi)
            $(this).find('#e_tio2_h2so4').val(tio2_h2so4)
            $(this).find('#e_s_pengeringan').val(s_pengeringan)
            $(this).find('#e_s_pemijaran').val(s_pemijaran)
            $(this).find('#e_kes_pewarna').val(kes_pewarna)
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#edit_ujitd').on('show.bs.modal', function(event) {
            ...
            $(this).find('#e_kel_h2so4p').val(kel_h2so4p)
            $(this).find('#e_kel_h2so4p').trigger("chosen:updated")
            $(this).find('#e_kel_hcip').val(kel_hcip)
            $(this).find('#e_kel_hcip').trigger("chosen:updated")
            $(this).find('#e_kel_air').val(kel_air)
            $(this).find('#e_kel_air').trigger("chosen:updated")
            $(this).find('#e_identifikasi').val(identifikasi)
            $(this).find('#e_tio2_h2so4').val(tio2_h2so4)
            $(this).find('#e_tio2_h2so4').trigger("chosen:updated")
            $(this).find('#e_s_pengeringan').val(s_pengeringan)
            $(this).find('#e_s_pemijaran').val(s_pemijaran)
            $(this).find('#e_kes_pewarna').val(kes_pewarna)
            $(this).find('#e_kes_pewarna').trigger("chosen:updated")
            $(this).find('#e_kondisi_py').val(kondisi_py)
