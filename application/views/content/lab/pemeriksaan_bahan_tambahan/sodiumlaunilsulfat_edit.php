<!-- Modal Uji Pewarna -->
<div class="modal fade" id="edit_ujisls" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls/update">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="e_identifikasi_ss" name="identifikasi_ss" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="e_kadar" name="kadar" autocomplete="off" placeholder="Kadar" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
...
<!-- <script type="text/javascript">
    $(document).ready(function() {
        $('#edit_ujisls').on('show.bs.modal', function(event) {
            ...
            $(this).find('#e_identifikasi_ss').val(identifikasi_ss)
            $(this).find('#e_kadar').val(kadar)
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#edit_ujisls').on('show.bs.modal', function(event) {
            ...
            $(this).find('#e_identifikasi_ss').val(identifikasi_ss)
            $(this).find('#e_identifikasi_ss').trigger("chosen:updated")
            $(this).find('#e_kadar').val(kadar)
            $(this).find('#e_kondisi_py').val(kondisi_py)
