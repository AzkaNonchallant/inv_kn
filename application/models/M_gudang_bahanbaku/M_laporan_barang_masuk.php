...
class M_laporan_barang_masuk extends CI_Model
{
    ...
    public function get($tgl = null, $tgl2 = null, $name = null)
    {
        ...
        $sql = "
            SELECT a.*,b.nama_supplier,c.nama_barang,c.satuan,c.qty_pack FROM tb_gbb_barang_masuk a
    ...
    {
        $sql = "
            SELECT a.*,b.nama_barang FROM tb_gbb_barang_masuk a
    ...
    {
        $query = "insert into tb_gbb_barang_masuk values($id_barang_masuk,$category)";
        $this->db->query($query);
    }
}
