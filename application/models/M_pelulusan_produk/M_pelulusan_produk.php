...
class M_pelulusan_produk extends CI_Model
{
    ...
    public function get($id = null)
    {
        ...
        $sql = "
        SELECT a.*,b.qty,b.stok FROM tb_prc_barang a
        LEFT JOIN tb_gbb_barang_masuk b ON a.id_barang = b.id_barang
    ...
    public function add($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_prc_barang`(`kode_barang`, `nama_barang`, `nama_produsen`, `negara_produsen`,`satuan`,`jenis_bahan`,`jenis_gel`,`qty_pack`,`sertif_halal`, `no_seri`,`ed_sertif`,`penerbit_halal`, `created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`) 
    ...
    public function cek_kode_barang($kode_barang){
        $sql = "
            SELECT COUNT(a.kode_barang) count_sj FROM tb_prc_barang a
