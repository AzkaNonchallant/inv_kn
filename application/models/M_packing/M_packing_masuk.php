...
class M_packing_masuk extends CI_Model
{
    ...
    public function get($id = null)
    {
        ...
        $sql = "SELECT * FROM tb_pck_packing_masuk WHERE is_deleted = 0 ORDER BY created_at ASC";
    ...
    public function add($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_pck_packing_masuk`(`no_msk`, `size`,`kw_cap`,`kw_body`, `warna_cap`,`warna_body`, `no_packing`, `no_batch`, `print`,`jumlah`, `jenis_pack`, `status_sk`,`created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`) 
    ...
    {
        $sql = "
            SELECT a.* FROM tb_pck_packing_masuk a
