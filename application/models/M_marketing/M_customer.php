...
class M_customer extends CI_Model
{
    ...
    public function get($id = null)
    {
        ...
        $sql = "SELECT * FROM tb_mkt_customer WHERE is_deleted = 0 ORDER BY created_at ASC";
    ...
    public function add($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_mkt_customer`( `kode_customer`, `nama_customer`, `negara`, `alamat`, `created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`) 
    ...
    public function cek_kode_customer($kode_customer){
        $sql = "
            SELECT COUNT(a.kode_customer) count_sj FROM tb_mkt_customer a
