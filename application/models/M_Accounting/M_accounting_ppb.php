...
class M_accounting_ppb extends CI_Model
{
    ...
    public function add_permintaan_barang($data)
{
    ...
    public function get($id = null)
    {
        ...
        WHERE a.is_deleted = 0 ORDER BY a.id_accounting_ppb_tf ASC";
        return $this->db->query($sql);
    ...
    public function cek_no_ppb($no_ppb_accounting)
    {
        $sql = "
            SELECT COUNT(a.no_ppb_accounting) count_sj FROM tb_prc_ppb a
            WHERE a.no_ppb_accounting = '$no_ppb_accounting' AND a.is_deleted = 0";
        return $this->db->query($sql);
    }
