...
class M_hasil_pemeriksaan_bt_nb extends CI_Model
{
    ...
    public function getnb($id = null)
    {
        ...
        $sql = "
            SELECT a.*,b.id_adm_bm,b.no_batch,b.id_user AS op_gudang,b.status_barang,b.jml_bm,c.tgl_dpb,c.no_sjl,d.nama_barang,d.jenis_barang FROM tb_lab_hasil_ujibt_natriumbenzoat a
