...
class M_hasil_pemeriksaan_bt_sls extends CI_Model
{
    ...
    public function getsls($id = null)
    {
        ...
        $sql = "
            SELECT a.*,b.id_prc_master_barang,b.id_adm_bm,b.no_batch,b.status_barang,b.jml_bm,b.id_user AS op_gudang,d.nama_barang,d.jenis_barang FROM tb_lab_hasil_ujibt_sodiumlaunilsulfat a
