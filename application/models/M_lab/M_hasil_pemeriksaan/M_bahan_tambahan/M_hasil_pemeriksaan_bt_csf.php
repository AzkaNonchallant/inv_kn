...
class M_hasil_pemeriksaan_bt_csf extends CI_Model
{
    ...
    public function getcsf($id = null)
    {
        ...
        $sql = "
            SELECT a.*,b.id_prc_master_barang,b.id_adm_bm,b.no_batch,b.id_user AS op_gudang,b.jml_bm,b.status_barang,c.no_sjl,d.nama_barang,d.jenis_barang FROM tb_lab_hasil_ujibt_candurinsilverfine a
