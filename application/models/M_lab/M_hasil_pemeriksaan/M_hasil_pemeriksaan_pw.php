...
class M_hasil_pemeriksaan_pw extends CI_Model
{
    ...
    public function get($id = null)
    {
        ...
        $sql = "
            SELECT a.*,b.id_barang,b.id_pb,b.tgl,b.no_surat_jalan,b.no_batch,b.status,b.dok_pendukung,b.op_gudang,b.jenis_kemasan,b.jml_kemasan,b.ditolak_kemasan,b.qty,b.ditolak_qty,b.exp,b.mfg,b.tutup,b.wadah,b.label,c.nama_supplier,d.nama_barang,d.jenis_bahan FROM tb_lab_hasil_ujipewarna a
    ...
    public function add_ujipw($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_lab_hasil_ujipewarna`(`id_pb`,`id_barang`,`id_supplier`,`tgl_uji`,`no_analis`,`penguji`,`pemerian`,`kelarutan`, `ident_air`,`ident_hcip`,`ident_naohp`,`ident_h2so4p`,`ident_t_larutan`,`s_pengeringan`,`p_kadar`,`kesamaan_std`,`kondisi_py`) 
