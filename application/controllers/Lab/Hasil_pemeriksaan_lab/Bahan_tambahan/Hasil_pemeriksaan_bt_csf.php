...
class hasil_pemeriksaan_bt_csf extends CI_Controller
{
    ...
    public function update()
    {
        ...
        $respon = $this->M_hasil_pemeriksaan_bt_csf->update($data);

        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_csf') . '?alert=success&msg=Selamat anda berhasil melakukan Uji Bahan Tambahan (Candurin Silver Fine)');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_csf') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Tambahan (Candurin Silver Fine)');
        }
    }
